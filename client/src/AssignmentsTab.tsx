...
type AssignmentsTabProps = {
    ...
    assignments: {
        assignment: {
            assignmentId: string, therapistName: string, therapistEmail: string, assignmentTitle: string, assignmentText: string, status: string, speech: {
                wpm: number,
                accuracy: number
            }, feedbackText: string
        }
...
function AssignmentsTab({ onAttemptClick, onBackClick, assignments }: AssignmentsTabProps) {
        ...
        const row = (
            <>
                <tr key={assignmentId} onClick={() => handleRowClick(assignmentId)}>
                    ...
                    <td>
                        <button disabled={status !== "todo"} className="assignments-view-btn" onClick={() => onAttemptClick(assignmentId, assignmentText)}>Attempt</button>
                    </td>
                </tr>
    ...
    return (
        <div className="assignments-tab">
            ...
            <div className="assignments-table-label" onClick={() => handleTableToggle("todo")}>Current Assignments</div>
            {todoRows.length ?
            ...
            <div className="assignments-table-label" onClick={() => handleTableToggle("completed")}>Completed Assignments</div>
            ...
            <div className="assignments-table-label" onClick={() => handleTableToggle("reviewed")}>Reviewed Assignments</div>
            {reviewedRows.length ?
